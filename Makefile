...
run-gpu:          ## loopback only: JupyterLab is tokenless outside VICE (remote: ssh -L 8888:127.0.0.1:8888 <gpu-host>)
	docker run --rm --gpus all -p 127.0.0.1:8888:8888 -e IPLANT_USER=$$USER "$(gpu_repotag)"
